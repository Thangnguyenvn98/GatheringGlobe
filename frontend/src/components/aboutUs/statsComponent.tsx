...
const StatsComponent = () => {
    const stats = [
        { percentage: "63%", description: "of people say that attending a concert would make them happy." },
        { percentage: "75%", description: "of people say making memories is the best part of attending a live event." },
        { percentage: "53%", description: "of people say getting hard-to-get tickets to a concert would be most impressive on a date." },
      ];
  return (
