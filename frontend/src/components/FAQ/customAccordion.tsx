...
const CustomAccordion:React.FC<customAccordionProps> = ({question,answer,expanded,setExpanded}) => {
  return (
    ...
    <Button 
       ...
       >
         ...
         <Plus className={`transform transition-transform duration-300 ${expanded ? 'rotate-45' : 'rotate-0'}`} />
       </Button>
    
    <div className={` transition-all duration-600 ease-out grid py-4 grid-rows-[0fr] ${expanded ? "grid-rows-[1fr] " : "grid-rows-[0fr]"}`}>
