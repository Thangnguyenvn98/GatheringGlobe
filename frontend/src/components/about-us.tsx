...
import { useServerTest, serverTestUsers } from "@/services/api";
const AboutUs = () => {
  const testMessageQuery = serverTestUsers();

  console.log(testMessageQuery);
          ...
          <div className="grid grid-cols-2">
            ...
            <div className="text-wrap text-sm">
              <p>
                ...
                creating seamless and unforgettable events. Our event platform
                is designed to simplify event planning and execution, allowing
                you to focus on what matters most: creating meaningful
              ...
              <p>
                ...
                questions and provide guidance throughout the planning process.
                We pride ourselves on being reliable, trustworthy, and dedicated
                to making your event a success.Thank you for considering our
                event management app for your next event. We look forward to
      ...
      <div className="flex justify-center bg-slate-950 p-4">
        <div className="flex flex-col p-2">
          ...
          <div className="grid grid-cols-3 gap-x-4 text-emerald-400 mt-4">
            ...
            <div className="flex flex-col gap-y-4 text-center">
              <h1 className="font-bold text-6xl">75%</h1>
              <p className="text-white">
                of people say making memories is the best part of attending a
                live event.
              </p>
            </div>
            <div className="flex flex-col gap-y-4 text-center">
              ...
              <p className="text-white">
                of people say getting hard-to-get tickets to a concert would be
                most impressive on a date.
              </p>
            </div>
          </div>
        </div>
          ...
          <section className="p-4">
            ...
            <div className="grid grid-cols-3 mt-10 gap-10">
              <div className="flex flex-col items-center text-center text-sm gap-y-4 ">
                ...
                <p>
                  There’s no reason to miss out. With tickets to millions of
                  events, and tools like Price Alert to help you stay within
                  budget, we have the ticket that’s right for you.
                </p>
              </div>

              <div className="flex flex-col items-center text-center text-sm gap-y-4">
                <h2 className="font-bold text-sm">
                  Service and a history you can trust.
                </h2>
                <TicketCheck size={60} />
                <p>
                  You can buy and sell with 100% confidence. With more than 130
                  trusted partners, award-winning customer service and a
                  convenient, feature-packed mobile app to buy and sell anytime,
                  anywhere, we’ve got you covered.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center text-center text-sm gap-y-4">
                ...
                <PartyPopper size={60} />
                <p>
                  The ticket is just the beginning! Loyalty perks for our top
                  buyers, personalized recommendations and surprise seat
                  upgrades are just a few of the ways we give fans more than
                  just the ticket.
                </p>
              </div>
            </div>
              ...
              <div className="grid grid-cols-2 auto-rows-auto gap-4">
                <div className="flex flex-col p-2 gap-y-4">
                  <h2 className="font-bold text-2xl">
                    Collaborate for seamless events
                  </h2>
                  <p>
                    At GatheringGlobe, we understand the importance of teamwork
                    in achieving a successful event. That's why we prioritize
                    working together with you to make your vision a reality.
                  </p>
                </div>
                <div className="flex flex-col  p-2 gap-y-4">
                  <h2 className="font-bold text-2xl">
                  ...
                  <p>
                    Clear communication and transparency are essential to
                    building trust. We committed to being upfront with our
                    pricing, services so that you can make informed decisions.
                  </p>
                </div>
                <div className="flex flex-col  p-2 gap-y-4">
                  <h2 className="font-bold text-2xl">
                    Goal and results obsessed
                  </h2>
                  <p>
                    At GatheringGlobe, we're driven by results. Creating an
                    unforgettable experience, or delivering a flawless
                    execution, we're obsessed with achieving the best possible
                    outcome for you.
                  </p>
                </div>
                <div className="flex flex-col  p-2 gap-y-4">
                  ...
                  <p>
                    We know that every event is unique, and we're always
                    striving to learn and improve from each one. At
                    GatheringGlobe, we believe in being better today than
                    yesterday.
                  </p>
                </div>
              </div>
