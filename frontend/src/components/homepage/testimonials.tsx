...
function Testimonials (){
    const contents:string[] = ["\"Joining this platform has been a game-changer for me! I've connected with like-minded individuals, attended amazing events, and made unforgettable memories. Highly recommend!\"- Sarah Smith"
