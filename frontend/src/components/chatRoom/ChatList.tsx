...
const ChatList: React.FC<ChatListProps> = ({
  ...
  return (
    <aside className="w-96 bg-white flex-shrink-0 overflow-y-auto sticky top-0 pb-10 border-r border-gray-200 shadow-lg">
      <div className="flex flex-col space-y-4 flex-grow p-4">
        <div className="flex items-center justify-between mb-4">
        ...
        <div className="relative mb-4">
          <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" />
          <Input
            className="pl-10 bg-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
            value={searchTerm}
            onChange={(e) => setSearchTerm(e.target.value)}
            type="text"
            placeholder="Search Community Chat"
